...
{
    public class NorthMarsRoverEngineProcess : MarsRoverEngineProcessBase
    {
        public NorthMarsRoverEngineProcess(int plateX, int plateY) : base(plateX, plateY)
        {
        }

        public override void Process(Traveler traveler)
        {
            if (traveler.Y < PlateY)
            {
                traveler.Y++;
            }
        }
